...
describe("ResultBaoViet.vue", () => {
  ...
  describe("carValue is < 500", () => {
    ...
    it("given carYear's gap from today <= 3, renders 2.2825% carValue", () => {
    ...
    it("given carYear's gap from today > 3 & <=6, renders 2.5795% carValue", () => {
      const wrapper = shallowMount(ResultBaoViet, {
        propsData: {
          carValue,
          carYear: thisYear - 4
    ...
    it("given carYear's gap from today >= 6, renders 2.6785% carValue", () => {
      const wrapper = shallowMount(ResultBaoViet, {
        propsData: {
          carValue,
          carYear: thisYear - 7
  ...
  describe("500 <= carValue < 700", () => {
    ...
    it("given carYear's gap from today <= 3, renders 2.0185% carValue", () => {
      const wrapper = shallowMount(ResultBaoViet, {
        propsData: {
          carValue,
          carYear: thisYear - 3
    ...
    it("given carYear's gap from today > 3 & <=6, renders 2.3045% carValue", () => {
      const wrapper = shallowMount(ResultBaoViet, {
        propsData: {
          carValue,
          carYear: thisYear - 4
    ...
    it("given carYear's gap from today >= 6, renders 2.4365% carValue", () => {
      const wrapper = shallowMount(ResultBaoViet, {
        propsData: {
          carValue,
          carYear: thisYear - 7
  ...
  describe("carValue >= 700", () => {
    ...
    it("given carYear's gap from today <= 3, renders 1.5345% carValue", () => {
      const wrapper = shallowMount(ResultBaoViet, {
        propsData: {
          carValue,
          carYear: thisYear - 3
    ...
    it("given carYear's gap from today > 3 & <=6, renders 1.7325% carValue", () => {
      const wrapper = shallowMount(ResultBaoViet, {
        propsData: {
          carValue,
          carYear: thisYear - 4
    ...
    it("given carYear's gap from today >= 6, renders 2.2055% carValue", () => {
      const wrapper = shallowMount(ResultBaoViet, {
        propsData: {
          carValue,
          carYear: thisYear - 7
