...
describe("class BaoMinhCarInsurance", () => {
  ...
  describe("setters", () => {
    it("setCarValue() is working", () => {
      ...
      const baoMinhCarInsurance = new BaoMinhCarInsurance(carValue, carYear);

      let expectedInsuranceFee = (carValue * 1.5) / 100;
      let insuranceFee = baoMinhCarInsurance.getInsuranceFee();
      expect(insuranceFee).toBe(expectedInsuranceFee);

      const newCarValue = 500;
      baoMinhCarInsurance.setCarValue(newCarValue);
      insuranceFee = baoMinhCarInsurance.getInsuranceFee();
    ...
    it("setCarYear() is working", () => {
      ...
      const insuranceFee1 = baoMinhCarInsurance.getInsuranceFee();
      baoMinhCarInsurance.setCarYear(LESS_THAN_3_YEARS);
      const insuranceFee2 = baoMinhCarInsurance.getInsuranceFee();
    ...
    it("setAddons() is working", () => {
      ...
      const insuranceFee1 = baoMinhCarInsurance.getInsuranceFee();
      baoMinhCarInsurance.setAddons([CarInsuranceAddOn.DKBS_003]);
      const insuranceFee2 = baoMinhCarInsurance.getInsuranceFee();
